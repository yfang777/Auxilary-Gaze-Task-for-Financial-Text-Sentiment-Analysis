...
class AdvPromptAttack:
    ...
    def attack(self, example, ground_truth_output):
        ...
        if goal_function_result.goal_status == GoalFunctionResultStatus.SKIPPED:
            ...
            # result.original_result.output, result.perturbed_result.attacked_text.text, result.perturbed_result.output, result.perturbed_result.score
            return result
...
def create_attack(args, goal_function):
    ...
    from bert_attack.label_constraint import LabelConstraint
    ...
    if args.attack == "textfooler":
        ...
        from bert_attack.transformations import CheckListTransformation
        from bert_attack.search import BruteForceSearch
        transformation = CheckListTransformation()
        constraints = []
        search_method = BruteForceSearch()   

    elif args.attack == "stresstest":
        from bert_attack.transformations import StressTestTransformation
        from bert_attack.search import BruteForceSearch
